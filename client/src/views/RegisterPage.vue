...
export default {
    ...
    methods: {
        ...mapActions(useRecipeStore, ['handleRegister','handleGithubSignIn']),
        handleSubmit(){
            this.handleRegister(this.name,this.email,this.password)
            console.log('masuk ya disini')
...
<template>
  ...
  <div class="signup-connect">
    ...
    <a @click.prevent="handleGithubSignIn" href="#" class="btn btn-social btn-google"><i class="fa fa-google"></i> Sign in with GitHub</a>
  ...
  <div class="signup-classic">
    ...
    <form  @submit.prevent="handleSubmit" class="form">
      ...
      <RouterLink to="/login"> <a><div class="signup-link">already have an account? Sign In Now</div></a></RouterLink>
    </form>
  </div>
</div>
