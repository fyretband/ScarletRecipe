...
export default {
    ...
    methods:{
        ...mapActions(useRecipeStore,['handleLogin']),
        handleSubmitLogin(){
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form @submit.prevent="handleSubmitLogin">
         ...
         <RouterLink to="/register">   <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="#!"
                class="link-danger">Register</a></p></RouterLink>
          </div>
